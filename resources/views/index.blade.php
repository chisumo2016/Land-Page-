...
@if(isset($portifolios )  && is_object($portifolios))
    <!-- Portfolio -->
         ...
         @endif
            ...
            <div class="isotope fadeInLeft animated wow" style="position: relative; overflow: hidden; height: 480px;" id="portfolio_wrapper">
                    ...
                    <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   {{ $item->filter }} isotope-item">
                        <div class="portfolio_img"> <img src="{{ asset('img/'.$item->images, $site->name) }}"  alt="Portfolio 1"> </div>
                ...
                @foreach($peoples as $k=>$people)
                    <div class="team_area">
                        ...
                        <div class="team_box wow fadeInDown delay-0 {{ ($k*3 + 3 )}}s">
                            ...
                            <img src="{{ asset('img/'.$people->images,$people->name )  }}" alt="">
...
@endif
    ...
    <footer class="footer_wrapper" id="contact">
        ...
        <div class="container">
            <div class="footer_bottom"><span>Copyright © 2017,    Created  by <a href="http://webthemez.com">Bernard Chisumo</a>. </span> </div>
        </div>
    </footer>
@endsection